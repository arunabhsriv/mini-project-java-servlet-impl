...
///////////////Service for Sports Table CRUD
	...
	public void addPlanUI() {
		Scanner sc=new Scanner(System.in);
		System.out.println("Enter plan details 1.sportid 2.planname 3.fees 4.duration ");
	...
	public void updatePlanUI() {
		Scanner sc=new Scanner(System.in);
		System.out.println("Enter plan details 1.sportid 2.planname 3.fees 4.duration ");
		Plans plan=new Plans(sc.nextInt(),sc.nextInt(), sc.next(), sc.nextDouble(), sc.nextInt());
		System.out.println("Enter the id of plan to be updated: ");
		int planId=sc.nextInt();

			try {
			System.out.println(manager.updatePlan(plan)+" rows affected");
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
